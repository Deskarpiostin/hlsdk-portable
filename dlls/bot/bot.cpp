...
const char *bot_skins[MAX_SKINS] = {
   "barney", "gman", "gordon", "gordon", "helmet",
   "recon", "robo", "scientist", "ivan", "skeleton"
};

// store the player names for each of the models...
const char *bot_names[MAX_NAMES] = {
   "gordo", "wallgausser", "Folks", "^1FIRREM", "^2EZ",
   "get good", "^2Prime", "uerro", "^1freeman", "Breacher",
